...
void USART2_TransmitString(char *str);
/* USER CODE BEGIN PFP */
...
//uint32_t Data[] = {0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9};
...
int main(void)
{
	...
	//HAL_FLASH_Unlock();
	//HAL_FLASH_Program(FLASH_TYPEPROGRAM_DOUBLEWORD, 0x08007800, data_to_write);
	//HAL_FLASH_Lock();
	/* USER CODE END 2 */
