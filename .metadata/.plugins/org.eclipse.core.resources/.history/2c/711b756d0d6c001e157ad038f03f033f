...
FanKnobBase::FanKnobBase()
{
    ...
    textAreaKnob.setColor(touchgfx::Color::getColorFromRGB(57, 57, 57));
    textAreaKnob.setLinespacing(0);
    Unicode::snprintf(textAreaKnobBuffer, TEXTAREAKNOB_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_3NAW).getText());
    textAreaKnob.setWildcard(textAreaKnobBuffer);
    textAreaKnob.setTypedText(touchgfx::TypedText(T___SINGLEUSE_N64L));
