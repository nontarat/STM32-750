...
Bitmap WasherContainer::getSelectedIconBitmap(int16_t index) const
{
    switch (index)
    {
    case 0:
...
Bitmap WasherContainer::getIconBitmap(int16_t index) const
{
    switch (index)
    {
    case 1:
...
void WasherContainer::centerAnimatedImageDone(const AnimatedImage&)
{
    ...
    else if (animationState == WASHING_DONE)
    {
...
uint16_t WasherContainer::getWashingProgram() const
{
    return currentProgram;
}


uint16_t WasherContainer::getWashingTime() const
{
    return washingTime;
}
