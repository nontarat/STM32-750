...
void HomeUIWheelSmallElements::setRoomInfo(int16_t item)
{
    ...
    if (showDevices)
    {
        ...
        case 0:
            ...
            textAreaRoom.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            textAreaDegree.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            textAreaDevices.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            textAreaBottomline.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            break;
        ...
        case 2:
            ...
            textAreaRoom.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            textAreaDegree.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            textAreaDevices.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            textAreaBottomline.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            break;
