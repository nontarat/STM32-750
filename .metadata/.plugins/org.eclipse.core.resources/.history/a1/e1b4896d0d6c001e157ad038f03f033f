...
void HomeUIWheelLargeElements::setRoomInfo(int16_t item)
{
    ...
    if (showDevices)
    {
        ...
        case 0:
            ...
            textAreaRoomLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            textAreaDegreeLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            textAreaDevicesLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            textAreaBottomlineLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_FOCUS_TEXT_R, HOME_UI_FOCUS_TEXT_G, HOME_UI_FOCUS_TEXT_B));
            break;
        ...
        case 2:
            ...
            textAreaRoomLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            textAreaDegreeLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            textAreaDevicesLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            textAreaBottomlineLarge.setColor(touchgfx::Color::getColorFromRGB(HOME_UI_UNFOCUS_TEXT_R, HOME_UI_UNFOCUS_TEXT_G, HOME_UI_UNFOCUS_TEXT_B));
            break;
