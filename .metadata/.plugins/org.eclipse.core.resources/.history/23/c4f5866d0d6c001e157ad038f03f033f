...
public:
    ...
    Bitmap getIconBitmap(int16_t index) const;
    ...
    uint16_t getWashingProgram() const;
    uint16_t getWashingTime() const;
...
protected:
    ...
    void fadeAnimationEndedHandler(const FadeAnimator<TextArea>& txt);
